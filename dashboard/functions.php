        ...
        if ($gateway == "twilio") {
            ...
            try {
                ...
                if ($response->sid) {
                    ...
                    echo '0|' . __('Message not sent. Please check your Twilio configuration.', 'adforest');
                    die();
                }
            } catch (\Exception $e) {
                echo '0|' . $e->getMessage();
    ...
    function adforest_bump_it_up()
    {
        ...
        if (get_post_field('post_author', $ad_id) == $user_id) {
            ...
            if (isset($adforest_theme['make_bump_up_paid']) && $adforest_theme['make_bump_up_paid'] == true) {
                ...
                $redirect_url = $url . "?pid=" . $ad_id;
                wp_send_json_success(array("message" => __("Post Bumped up Submit.", 'adforest'), 'url' => $redirect_url));
