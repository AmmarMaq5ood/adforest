                ...
                <div class="col-lg-4 col-xl-3">
                    ...
                    <div class="profile-content-left profile-left-spacing pt-5 pb-3 px-3 px-xl-5">
                        <div class="card text-center widget-profile px-0 border-0">
                            <div class="card-img mx-auto user-dp-container">
                                ...
                                <img src="<?php echo esc_url($user_pic); ?>"
                                    alt="<?php echo esc_html('img', 'adforest') ?>" id="img-upload">
                                <div class="edit-dp"><a href="#"><i class="fa fa-camera" aria-hidden="true"
                                            id="upload_user_dp"></i></a>
                                </div>
                                <input type="file" id="imgInp" name="my_file_upload[]" accept="image/*"
                                    class="sb_files-data form-control">
                            </div>
                        ...
                        <div class="contact-info pt-4">
                            ...
                            <p class="font-weight-medium pt-4 mb-2"><i
                                    class="fa fa-volume-control-phone"></i><?php echo esc_html__('Phone number', 'adforest') ?>
                            </p>
                            <p><?php echo esc_html(get_user_meta($user_id, '_sb_contact', true)) . $is_verified; ?> </p>
                            <p class="font-weight-medium pt-4 mb-2"><i
                                    class="fa fa-users"></i><?php echo esc_html__('Social Profile', 'adforest') ?></p>
                        ...
                        <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="edit-profile-tab" data-toggle="tab" href="#edit-profile"
                                    ...
                                    aria-selected="false"><?php echo esc_html__('Edit Profile', 'adforest') ?></a>
                            </li>
                        </ul>
                                ...
                                <div class="tab-pane-content mt-5">
                                    ...
                                    <form class="form-pill" id="sb_update_profile">
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label"
                                                        for="sb_user_name"><?php echo esc_html__('Your Name', 'adforest') ?></label>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo __('Email Address', 'adforest') ?> <span
                                                            class="color-red">*</span></label>
                                                    <input <?php echo esc_attr($email_name); ?> type="text"
                                                        class="form-control margin-bottom-20"
                                                        value="<?php echo esc_attr($user_info->user_email) ?>" <?php echo esc_attr($readonly) ?>>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo __('Contact Number', 'adforest') ?><span
                                                            class="color-red">*</span></label>
                                                    <input type="text" class="form-control margin-bottom-20"
                                                        name="sb_user_contact" id="sb_user_contact"
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo __('I am', 'adforest') ?> <span
                                                            class="color-red">*</span></label>
                                            ...
                                            if ($adforest_theme['sb_show_whatsapp_intro'] == '1') {
                                                echo '<div class="col-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label>' . __('Whatsapp Intro', 'adforest') . ' <span class="color-red"></span></label>
                                                            <textarea name="sb_user_whatsapp_intro" class="form-control" rows="6">' . esc_attr(get_user_meta($user_info->ID, '_sb_user_whatsapp_intro', true)) . '</textarea>
                                                        </div>
                                                    </div>';
                                            }

                                            echo '<input type="hidden" id="adforest_profile_msg" value="' . __('Profile saved successfully.', 'adforest') . '" />
