            ...
            <div class="col-xxl-10 col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 col-pm">
                <div class="found-adforest found-sidebar">
                    <div class="found-adforest-heading">
                        <h5><?php echo esc_html($results->found_posts); ?>
                            <?php echo __('Found Ads', 'adforest') . ":"; ?> <?php
                                   $param = $_SERVER['QUERY_STRING'];
                                   if ($param != "") {
                                       ?>
                                <span><a class="filterAdType-count"
                                        href="<?php echo get_the_permalink($sb_search_page); ?>"><?php echo __('Reset Search', 'adforest'); ?></a></span>
                            <?php } ?>
                        </h5>
                    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xxl-10 col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 col-pm">
                ...
                <?php
                if (isset($adforest_theme['recently_viewed_on_search']) && $adforest_theme['recently_viewed_on_search']) {
                    $countries_location = '';
                    $countries_location = apply_filters('adforest_site_location_ads', $countries_location, 'search');
                    if (is_user_logged_in()) {
                        ...
                        if ($recently_viewed && is_array($recently_viewed)) {
                            ...
                            $ads = new ads();
                            echo adforest_returnEcho($ads->adforest_get_ads_grid_slider($args, "Recently Viewed", 4, ''));
                        }
                    }
                }
                ?>
                            ...
                            <div class="ad-alert-box">
                                <div class="row">
                                    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <p><?php echo esc_html__('Receive emails for the latest Ads matching your search criteria', 'adforest') ?>
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                        <a href="javascript:void(0)"
                                            class="btn btn-theme  ad_alerts"><?php echo esc_html__('Create Alert', 'adforest') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row posts-masonry" id="ads-search-container">
                        ...
                        if ($results->have_posts()) {
                            ...
                            if (in_array($search_ad_layout_for_sidebar, $layouts)) {
                                ...
                                ?>
                                <div class="row posts-masonry" id="ad-list"></div>
                                <?php
                            } else {
