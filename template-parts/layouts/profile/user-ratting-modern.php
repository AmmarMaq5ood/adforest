                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="public-link-provider-1">
                                            <div class="form-group">
                                                ...
                                                <textarea cols="6" rows="6" class="form-control" id="sb_rate_user_comments" name="sb_rate_user_comments" data-parsley-required="true" data-parsley-error-message="<?php echo __('This field is required.', 'adforest'); ?>">   <?php echo esc_html($comments); ?> </textarea>
                                            ...
                                            <div class="pro-response-head">
                                                ...
                                                <ul>
                                                    ...
                                                    ?>
                                                            ...
                                                            <li><a href="javascript:void(0)" class="user_rating_dlt" data-userid="<?php echo $author_id; ?>" data-confirmation="<?php echo __('Are you sure you want to delete this?', 'adforest') ?>"><?php echo esc_html__('Delete', 'adforest'); ?>
                                                                </a>
                                                            </li>
                                                    <?php
                                                                                                                                                            }
