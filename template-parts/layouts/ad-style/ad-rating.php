                        ...
                        <div class="review-content">
                            <div class="review-img">
                                <a href="<?php echo adforest_set_url_param(get_author_posts_url($comment->user_id), 'type', 'ads'); ?>">
                                    <img src="<?php echo adforest_get_user_dp($comment->user_id, 'adforest-single-small'); ?>"
                                        alt="<?php echo esc_attr($commenter->display_name); ?>">
                                </a>
                            </div>
                            ...
                            <div class="review-content-item">
                                <?php if (get_post_meta($pid, '_adforest_ad_status_', true) == 'active' && get_current_user_id() == $poster_id) {
                                    ?>
                                    <div class="review-reply">
                                        <a class="reply-btn reply_ad_rating" href="javascript:void(0);"
                                            data-comment_id="<?php echo adforest_returnEcho($comment->comment_ID); ?>"
                                            data-commenter-name="<?php echo esc_attr($commenter->display_name); ?>" data-bs-toggle="modal"
                                            data-bs-target=".reply_rating">
                                ...
                                <div class="review-head">
                                    <h5 class="author-name">
                                        <a
                                            href="<?php echo adforest_set_url_param(get_author_posts_url($comment->user_id), 'type', 'ads'); ?>"><?php echo esc_html($commenter->display_name); ?></a>
                                    </h5>
                                </div>
                                <ul class="review-list">
                                    ...
                                    <?php } ?>
                                    <li><span
                                            class="list-posted-date"><?php echo get_comment_date(get_option('date_format'), $comment->comment_ID); ?></span>
                                    </li>
                                    ...
                                    if ($comment->user_id == get_current_user_id() || is_super_admin(get_current_user_id())) {
                                        ...
                                        if (isset($adforest_theme['ads_rewiew_delete']) && $adforest_theme['ads_rewiew_delete']) {
                                            ?>
                                            <li> <a href="javascript:void(0)" class="ads_rating_dlt"
                                                    data-comment_id="<?php echo $comment->comment_ID; ?>" data-ad_id="<?php echo $pid; ?>">
                                ...
                                <div class="review-img-container">
                                    ...
                                    if (isset($full_img[0])) {
                                        ...
                                        <a href="<?php echo $full_img; ?>"
                                            data-fancybox="images-preview-<?php echo '' . $comment->comment_ID; ?>"> <img
                                                src="<?php echo $full_img[0]; ?>" class="img-responsive" alt="imagess" /><?php ?></a>
                                    <?php } ?>
                                </div>
                                ...
                                if (isset($adforest_theme['adforest_listing_review_enable_emoji']) && $adforest_theme['adforest_listing_review_enable_emoji']) {
                                    ...
                                    <div class="review-helpful">
                                        <span><?php echo esc_html__('Your reaction about this review', 'adforest'); ?></span>
                                        <div class="Like">
                                            <div class="Emojis">
                                                <div class="Emoji  Emoji-like" data-reaction="1"
                                                    data-cid="<?php echo esc_attr($comment->comment_ID); ?>">
                                                    <div class="emoji-name"> <?php echo esc_html__('Like', 'adforest'); ?></div>
                                                    <div class="icon icon-like"></div>
                                                    <div class="emoji-count likes-<?php echo esc_attr($comment->comment_ID); ?>">
                                                        <?php echo esc_attr($got_likes); ?></div>
                                                </div>
                                                <div class="Emoji Emoji-love" data-reaction="2"
                                                    data-cid="<?php echo esc_attr($comment->comment_ID); ?>">
                                                    <div class="emoji-name"> <?php echo esc_html__('Love', 'adforest'); ?></div>
                                                    <div class="icon icon-heartt"></div>
                                                    <div class="emoji-count loves-<?php echo esc_attr($comment->comment_ID); ?>">
                                                        <?php echo esc_attr($got_love); ?> </div>
                                                </div>

                                                <div class="Emoji Emoji-wow" data-reaction="3"
                                                    data-cid="<?php echo esc_attr($comment->comment_ID); ?>">
                                                    <div class="emoji-name"> <?php echo esc_html__('Wow', 'adforest'); ?></div>
                                                    <div class="icon icon-wow"></div>
                                                    <div class="emoji-count wows-<?php echo esc_attr($comment->comment_ID); ?>">
                                                        <?php echo esc_attr($got_wow); ?> </div>
                                                </div>

                                                <div class="Emoji Emoji-angry" data-reaction="4"
                                                    data-cid="<?php echo esc_attr($comment->comment_ID); ?>">
                                                    <div class="emoji-name"> <?php echo esc_html__('Angry', 'adforest'); ?></div>
                                                    <div class="icon icon-angry"></div>
                                                    <div class="emoji-count angrys-<?php echo esc_attr($comment->comment_ID); ?>">
                                                        <?php echo esc_attr($got_angry); ?> </div>
                                                </div>
                                                <img id="reaction-loader-<?php echo esc_attr($comment->comment_ID); ?>" class="none"
                                                    src="<?php echo esc_url(trailingslashit(get_template_directory_uri()) . 'images/adforest_loader.gif'); ?>"
                                                    alt="<?php echo esc_html__('not found', 'adforest'); ?>">
                                            </div>
        ...
        if (get_post_meta($pid, '_adforest_ad_status_', true) == 'active') {
            ...
            <form method="post" id="ad_rating_form" enctype="multipart/form-data">
                ...
                if ($sb_ad_rating_start) {
                    ...
                    <div class="col-md-12 col-sm-12 no-padding">
                        <div class="form-group">
                            <div dir="ltr">
                                <input id="input-21b" name="rating" value="1" type="text" data-show-clear="false" <?php if (is_rtl()) { ?> dir="rtl" <?php } ?>class="rating" data-min="0" data-max="5" data-step="1"
                ...
                <div class="col-md-12 col-sm-12 no-padding">
                    <div class="form-group">
                        ...
                        <textarea cols="6" name="rating_comments" rows="6"
                            placeholder="<?php echo __('Your comments...', 'adforest'); ?>" class="form-control re-mdg"
                ...
                <div class="col-md-12 col-sm-12 no-padding">
                    ...
                    <input class="btn btn-theme btn btn-sub" value="<?php echo __('Submit Review', 'adforest'); ?>"
                        type="submit">
                    ...
                    <form id="rating_reply_form">
                        <div class="modal-content <?php echo esc_attr($flip_it); ?>">
                            <div class="modal-header">
                                ...
                                <div class="modal-title"><?php echo __('Reply to', 'adforest'); ?> <span
                                        id="reply_to_rating"></span></div>
                            </div>
                            <div class="modal-body <?php echo esc_attr($flip_it); ?>">
                                <div class="form-group  col-md-12 col-sm-12">
                                    <label></label>
                                    <textarea placeholder="<?php echo __('Write your reply...', 'adforest'); ?>" rows="3"
                                ...
                                <div class="col-md-12 col-sm-12 margin-bottom-20 margin-top-20">
                                    ...
                                    <input type="hidden" value="<?php echo adforest_returnEcho($pid); ?>" name="ad_id" />
                                    <input type="hidden" value="<?php echo adforest_returnEcho($poster_id); ?>"
                                        name="ad_owner" />
                                    <input type="submit" class="btn btn-theme btn-block"
                                        value="<?php echo __('Submit', 'adforest'); ?>" />
                                </div>
                            </div>
                        </div>
                    </form>
