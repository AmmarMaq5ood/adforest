                    ...
                    <div class="sale-head">
                        ...
                        <ul class="clendar-head">
                            <li><a href="javascript:void(0)" class="update-item"
                                    alt="<?php echo esc_attr__('void', 'adforest'); ?>"><i class="fa fa-calendar"></i>
                                    <?php echo get_the_date(); ?></a></li>
                            <li><a href="javascript:void(0)" class="update-item"
                                    alt="<?php echo esc_attr__('void', 'adforest'); ?>">
                                    <?php echo esc_html__('Views:', 'adforest') ?><span><?php
                            ...
                            if (!$is_demo && get_post_field('post_author', $pid) == get_current_user_id() || is_super_admin(get_current_user_id())) {
                                ...
                                ?>
                                <li><a
                                        href="<?php echo esc_url($ad_update_url); ?>"><?php echo __('Edit', 'adforest'); ?></a>
                                </li>
                                <?php
                            }
                            ?>
                ...
                <div class="list-feature">
                    <ul class="listning-list-all">
                        ...
                        if (get_post_meta($pid, '_adforest_ad_yvideo', true) != "") { ?>
                            <li><a id="play-video"
                                    href="<?php echo get_post_meta($pid, '_adforest_ad_yvideo', true); ?>"><?php echo esc_html__('Video', 'adforest') ?></a>
                            </li>
                        <?php }
                        ...
                        <li><a href="#related-ads-container"><?php echo esc_html__('Related Ads', 'adforest') ?></a>
                        </li>
                    ...
                    <div class="cont-list-detail">
                        ...
                        <div class="heading-detail">
                            <div class="detail-img">
                                <a
                                    href="<?php echo adforest_set_url_param(get_author_posts_url($poster_id), 'type', 'ads'); ?>"><img
                                        src="<?php echo esc_attr($user_pic); ?>" id="user_dp"
                                        alt="<?php echo __('Profile Picture', 'adforest'); ?>" class="img-fluid"></a>
                                ...
                                if (get_user_meta($poster_id, '_sb_badge_type', true) != "" && get_user_meta($poster_id, '_sb_badge_text', true) != "" && isset($adforest_theme['sb_enable_user_badge']) && $adforest_theme['sb_enable_user_badge']) {
                                    ?>
                                    <div
                                        class="heading-detail-check <?php echo get_user_meta($poster_id, '_sb_badge_type', true); ?>">
                            ...
                            <div class="deatil-head">
                                <div class="listing-ratings">
                                    ...
                                    if (isset($adforest_theme['sb_enable_user_ratting']) && $adforest_theme['sb_enable_user_ratting']) {
                                        ?>
                                        <a
                                            href="<?php echo adforest_set_url_param(get_author_posts_url($poster_id), 'type', 1); ?>">
                                ...
                                // if ($user_type == "") {
                                ?><span
                                    class="label-user label-success"><?php echo adforest_returnEcho($user_type); ?></span>
                                <?php //}    
                                ?>
                            </div>
                        </div>
                        <?php if (get_post_meta($pid, '_adforest_ad_type', true) != "") { ?>
                            <div class="ad-type">
                                ...
                                <div class="sell-content">
                                    <img src="<?php echo esc_url($link1); ?>"
                                        alt="<?php echo esc_html__('ad type', 'adforest'); ?>"> <span
                                        class="ad-type-text"><?php echo adforest_returnEcho($ad_type_val); ?></span>
                                    <span class="sell-icon"><img src="<?php echo esc_url($link2); ?>"
                                            alt="<?php echo esc_html__('ad type', 'adforest'); ?>"></span>
                                </div>
                            </div>
                            <?php
                        ...
                        if ($adforest_theme['communication_mode'] == 'both' || $adforest_theme['communication_mode'] == 'phone') {
                            ...
                            if ($contact_num != "") {
                                ...
                                if (adforest_showPhone_to_users()) {
                                    ...
                                    ?>
                                    <div class="details-click-view phone"><a data-ad-id="<?php echo intval($pid); ?>"
                                            href="<?php echo adforest_returnEcho($call_now); ?>" class="sb-click-num2"
                                            id="show_ph_div"><span class="info-heading"><i
                                                    class="fa fa-phone"></i><?php echo esc_html__('Phone :', 'adforest') ?></span><span
                                                class="sb-phonenumber"><?php echo esc_html__('Login to view', 'adforest'); ?></span><?php if ($batch_text != "") { ?><small
                                                    class="sb-small">-<?php echo adforest_returnEcho($batch_text); ?></small><?php } ?></a>
                                    </div>

                                <?php } else { ?>

                                    <div class="details-click-view phone"><a data-ad-id="<?php echo intval($pid); ?>"
                                            href="<?php echo adforest_returnEcho($call_now); ?>" class="sb-click-num"
                                            id="show_ph_div"><span class="info-heading"><i
                                                    class="fa fa-phone"></i><?php echo esc_html__('Phone :', 'adforest') ?></span><span
                                                class="sb-phonenumber"><?php echo esc_html__('Click to view', 'adforest'); ?></span><?php if ($batch_text != "") { ?><small
                                                    class="sb-small">-<?php echo adforest_returnEcho($batch_text); ?></small><?php } ?></a>
                                    </div>
                        ...
                        <div class="detail-msg">
                            ...
                            if ($allow_whatsapp && $contact_num != "") {
                                ...
                                ?>
                                <a href="<?php echo $redirect_url ?>" class="btn btn-whatsap" target="_blank">
                            ...
                            if ($allow_whizchat) {
                                ...
                                <a href="javascript:void(0)" class="btn btn-whizchat chat_toggler"
                                    ...
                                    data-user_id="<?php echo esc_attr($poster_id) ?>">
                                    ...
                                    <form id="send_message_pop" method="post">
                                        ...
                                        <div class="form-group">
                                            <textarea id="sb_forest_message" name="message"
                                                placeholder="<?php echo __('Type here...', 'adforest'); ?>" rows="8"
                                        ...
                                        <?php if ($allow_attachment) { ?>
                                            ...
                                            <div class="file_attacher" id="file_attacher">
                                                <a href="javascript:void(0)" class="msgAttachFile  dz-clickable"><i
                                                        class="fa fa-link"></i>&nbsp;
                                                    <?php echo esc_html__('Add Attachment', 'adforest'); ?></a><!-- comment -->
                                                <input type="hidden" name="attachments_list" value="[]">
                                            </div>
                                        <?php } ?>

                                        <input type="hidden" name="ad_post_id" id="ad_post_id"
                                        ...
                                        <input type="hidden" name="msg_receiver_id" id="msg_receiver_id"
                                            value="<?php echo esc_attr($poster_id); ?>" />
                                        <input type="hidden" id="sb-msg-token"
                                            value="<?php echo wp_create_nonce('sb_msg_secure'); ?>" />
                                        <button type="submit" id="send_ad_message" class="btn btn-theme btn-block">
                                            <?php echo __('Send Message', 'adforest'); ?></button>
                                    </form>
                                </div>
                                <?php
                            }
                        ...
                        <ul class="cont-icon-list">
                            <li><a
                                    href="<?php echo adforest_set_url_param(get_author_posts_url($poster_id), 'type', 'ads'); ?>"><svg
                            ...
                            ?>
                            <li class="<?php echo $is_fav; ?>"><a href="javascript:void(0);" class="ad_to_fav"
                                    data-adid="<?php echo get_the_ID(); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false"
                        ...
                        <div class="main-section-bid">
                            <div class="country-locations">
                                <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'images/earth-globe.png'; ?>"
                                    alt="<?php echo esc_html__('Globe location', 'adforest'); ?>" />
                                <div class="class-name">
                                    <div id="word-count"><?php echo adforest_display_adLocation($pid); ?></div>
                                </div>
                            </div>
                        </div>
                    ...
                    if (isset($adforest_theme['allow_claim']) && $adforest_theme['allow_claim']) {
                        ...
                        if (get_post_meta($pid, 'sb_listing_is_claimed', true) != '' && get_post_meta($pid, 'sb_listing_is_claimed', true) == '1') {
                            ...
                            <div class="main-section-bid claim-now">
                                <div class="widget">
                                    <div class="claim"> <a href="javascript:void(0)"> <img
                                                src="<?php echo esc_url($checked_img); ?>"
                                                alt="<?php echo esc_html__('Claimed', 'adforest'); ?>"><?php echo esc_html__('Claimed', 'adforest'); ?>
                                        </a> </div>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="main-section-bid claim-now">
                                <div class="widget">
                                    <div class="claim"> <a class="claim_ad" href="javascript:void(0)"> <img
                                                src="<?php echo esc_url($img_medal) ?>"
                                                alt="Claim Now"><?php echo esc_html__('Claim Now', 'adforest') ?> <i
                        ...
                        <div class="main-section-bid safety-tips">
                            <div class="widget-heading">
                                <div class="panel-title">
                                    <span><?php echo adforest_returnEcho($adforest_theme['tips_title']); ?></span></div>
                            </div>
