                                        ...
                                        <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12">
                                            <div class="ad-detail-2-ad-type">
                                                ...
                                                <div class="ad-detail-2-sell-content">
                                                    <img src="<?php echo esc_url($link1); ?>" alt="<?php echo esc_html__('ad type', 'adforest'); ?>"> <span class="ad-type-text"><?php echo $ad_type_val; ?></span>
            ...
            if (get_user_meta(get_current_user_id(), '_sb_fav_id_' . $pid, true) == $pid) {
                ...
                <div class="ad-detail-2-user">
                    ...
                    if ($allow_whatsapp && $contact_num != "") {
                        ...
                        ?>
                        <a  href="<?php echo $redirect_url; ?>" class="btn btn-whatsap btn-block" target ="_blank">
