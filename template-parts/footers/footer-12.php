            ...
            <div class="will-never">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                       <form>
                                    <input name="sb_email" id="sb_email" placeholder="<?php echo esc_html__('Enter your email address', 'adforest'); ?>" type="text" autocomplete="off" required="">
                                    <input class="submit-btn btn-theme" id="save_email" value="<?php echo esc_html__('Submit', 'adforest'); ?>" type="button">
                                    <input class="submit-btn no-display" id="processing_req" value="<?php echo esc_html__('Processing...', 'adforest'); ?>" type="button" style="display: none;">
            ...
            <div class="col-12 col-md-12 col-lg-4">
                ...
                <div class="follow-heading">
                    ...
                    <ul class="socials-links">
                        ...
                        <li><a target="_blank" href="<?php echo esc_url($val)?>" <?php  do_action('adforest_relation_follow_links') ?> ><i class=" <?php echo  adforest_social_icons($index) ?> "></i></a></li>
