 ...
 <footer class="minimal-footer sb-foot-4 text-center <?php echo esc_attr ($footer_bg); ?>">
    <div class="container">
       <ul class="footer-social text-center">
            ...
            <?php if($val != "") { ?><li><a  target="_blank" <?php do_action('adforest_relation_follow_links');?>href="<?php echo esc_url($val); ?>"><span class="<?php echo adforest_social_icons( $index ); ?>"></span></a></li><?php  } } ?>
       </ul>
       <p class="copy-rights">
		<?php
