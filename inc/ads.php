                ...
                if ($fav_ads == 'no' || 'expired_sold' == $fav_ads || $fav_ads == 'featured_ads') {
                    ...
                    if (get_post_meta($pid, '_adforest_is_feature', true) != '1') {
                        ...
                        if ($featured_ads != 0 && $featured_ads != "" && ($sb_expire_ads != '-1' || $sb_expire_ads < date('Y-m-d'))) {
                            ...
                            $ad_featured = '<a class="mb-1 btn btn-sm btn-info mr-2 sb_anchor sb_make_feature_ad_new_pkg" href="javascript:void(0);"  data-aaa-id="' . esc_attr($pid) . '">' . __('Mark featured', 'adforest') . '</a>';
                        }
                    ...
                    $add_ons = '<div class="bump-or-feature">
                     ' . $ad_featured . '
                     <a class="mb-1 btn btn-sm btn-info '.$bump_up_ads_class.'" href="javascript:void(0);" data-aaa-id="' . esc_attr($pid) . '">' . __('Bump up', 'adforest') . '</a>
                    </div>';
                }
