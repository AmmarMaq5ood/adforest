...
if (!class_exists('Adforest_AdPost_Categories')) {
    class Adforest_AdPost_Categories
    {
        ...
        {
            global $adforest_theme;
            if (isset($adforest_theme['is_sub_cat_required']) && $adforest_theme['is_sub_cat_required'] == true) {
                $modal_html = '<div class="panel panel-default my_panel">
                            <div class="search-modal modal  fade cats_model" data-bs-backdrop="static" id="cat_modal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <p>' . __('Select Category first', 'adforest') . '</p>
                                        </div>
