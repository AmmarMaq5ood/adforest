        ...
        vc_map(array(
            ...
            'params' => array(
                ...
                array(
                    "group" => __("Basic", "adforest"),
                    "type" => "dropdown",
                    "heading" => __("Image Side", 'adforest'),
                    "param_name" => "call_img_side",
                    "admin_label" => true,
                    "value" => array(
...
if (!function_exists('adforest_call_to_action_service_func')) {
    ...
    function adforest_call_to_action_service_func($atts, $content = '') {
        ...
        if(!isset($section_bg)){
            ...
            $left_side_img = '' ;
            $right_side_img = '';
            if( $call_img_side == 'left'){
                $left_side_img = '<div class="col-xxl-6 col-lg-6 col-md-12 col-sm-12">
                                    <div class="srvs-providers"> <img src="' . esc_url($call_img) . '" alt="' . esc_html__('Call to Action image', 'adforest') . '" class="img-fluid"> </div>
                                </div>';
            }
            if( $call_img_side == 'right') {
                $right_side_img = '<div class="col-xxl-6 col-lg-6 col-md-12 col-sm-12">
                                    <div class="srvs-providers"> <img src="' . esc_url($call_img) . '" alt="' . esc_html__('Call to Action image', 'adforest') . '" class="img-fluid"> </div>
                                </div>';
            }
        //}
                    ...
                    <div class="container">
                      ...
                      '.$left_side_img.'
                        <div class="col-xxl-6 col-lg-6 col-md-12 col-sm-12">
                          <div class="srvs-prov-details child">
