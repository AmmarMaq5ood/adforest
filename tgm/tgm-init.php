...
function sb_themes_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        array(
            ...
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/elementor.3.21.5.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/dc-woocommerce-multi-vendor.4.1.10.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/contact-form-7.5.9.4.zip'),
            'is_callable' => '',
        ),
        array(
