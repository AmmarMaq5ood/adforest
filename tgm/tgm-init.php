...
function sb_themes_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        array(
            ...
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/elementor.3.24.4.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/dc-woocommerce-multi-vendor.4.2.2.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/woocommerce.9.3.3.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/one-click-demo-import.3.2.1.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/contact-form-7.5.9.8.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/add-to-any.1.8.10.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/wp-twilio-core.1.5.9.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/advanced-custom-fields.6.3.6.zip'),
            'is_callable' => '',
        ),
    );
    /*
